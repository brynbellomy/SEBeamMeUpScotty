...
Pod::Spec.new do |s|
  ...
  s.dependency 'BrynKit/RACHelpers', '>= 1.2.0'
  s.dependency 'BrynKit/CocoaLumberjack', '>= 1.2.0'
  s.dependency 'StateMachine-GCDThreadsafe', '>= 0.0.1'
  s.dependency 'CocoaLumberjack'

  s.source_files = 'Classes/{SEUpload.h,SEUploadController.{h,m}}'
  ...
  s.subspec 'Facebook' do |subspec|
    ...
    subspec.dependency 'Facebook-iOS-SDK', '~> 3.1.1'
  end

  s.subspec 'YouTube' do |subspec|
    subspec.source_files = 'Classes/SEYouTube*.{h,m}'
    subspec.dependency 'iOS-GTLYouTube'
  end
